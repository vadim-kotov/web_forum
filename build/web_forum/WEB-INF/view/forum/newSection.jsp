...
<body>
    ...
    <div id="wrapper">
        ...
        <c:if test="${not empty section.sectionId}>">
            <c:set var="formAction" value="/web_forum/forum/${section.sectionId}/newsection.do"/>
        </c:if>
        <div id="main">
            <div id="second-wrapper">
                <h3>Создать раздел</h3>
                <form:form id="new-section" class="third-wrapper" novalidate="true" action="${formAction}" modelAttribute="newSection" method="POST">
