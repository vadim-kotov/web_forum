...
import model.Text;
import model.banlist.*;
import model.Topic;
import static test.BanlistManagerTest.compBanlists;
import static test.TopicManagerTest.compTopics;
import static test.SectionManagerTest.getSubsections;
import static test.SectionManagerTest.compForumTopics;
import static test.MessageManagerTest.compMessages;
import static test.MessageObjectManagerTest.compMessageObjects;
import static model.UserManager.Filter;
import static model.UserManager.UserInfo;
import static model.UserManager.compUserId;
import static model.UserManager.getFullFilter;
import static model.SectionManager.ForumTopic;
import static model.SectionManager.compTopicId;
